...
def make_output_filename(title, created_dt):
    """
    Name the output file as: YYYY-MM-DD Title.md
    The date prefix ensures alphabetical sort = chronological sort in Obsidian.
    """
    ...
    for i, fname in enumerate(sdocx_files, 1):
        ...
        try:
            with zipfile.ZipFile(fpath, 'r') as zf:
                ...
                out_name = make_output_filename(title, created_dt)
